...
export class GameScene extends Phaser.Scene {
  ...
  createUI() {
    ...
    this.hpBarFill = this.add.rectangle(90, 32, 300, 12, 0x00ff88).setDepth(11).setOrigin(0, 0.5);
    this.hpText    = this.add.text(240, 32, 'HP 100', { fontSize: '10px', color: '#000' }).setOrigin(0.5).setDepth(12);
